...
module TwoHorizontalBarChart
  ...
  def question_three(folder_name, file_name)
    processing("#{folder_name}/#{file_name}")
  end
end

include TwoHorizontalBarChart
...
file_name = TwoHorizontalBarChart.get_file_name(date_str, folder_name)

TwoHorizontalBarChart.question_three(folder_name, file_name[0])
