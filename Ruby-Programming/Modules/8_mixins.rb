...
# and this methodology is called mixin in Ruby. W
# e can use simple include keyword for including many modules inside a class and we know that every modules can have some class and methods.
